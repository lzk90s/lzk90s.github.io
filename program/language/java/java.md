...
- [1. ==和 equals 的区别](#1-和-equals-的区别)
- [2. 什么是反射？](#2-什么是反射)
- [3. 四种引用状态](#3-四种引用状态)
- [4. 包装类的常量池](#4-包装类的常量池)
- [5. String 常量池](#5-string-常量池)
- [6. String 为什么要设置成 final 的？](#6-string-为什么要设置成-final-的)
- [7. 自动拆箱装箱](#7-自动拆箱装箱)
- [8. ClassNotFoundException 和 NoClassDefFoundException 的区别？](#8-classnotfoundexception-和-noclassdeffoundexception-的区别)
- [9. java 线程状态](#9-java-线程状态)
- [10. Thread.sleep、Thread.yield、obj.wait、t.join 的区别？](#10-threadsleep-threadyield-objwait-tjoin-的区别)
- [11. 三种代理模式](#11-三种代理模式)
  - [11.1. 静态代理（implement interface）](#111-静态代理implement-interface)
  - [11.2. jdk 中的 Proxy.newProxyInstance 动态代理（implement interface）](#112-jdk-中的-proxynewproxyinstance-动态代理implement-interface)
  - [11.3. cglib 代理（extends class）](#113-cglib-代理extends-class)
    - [11.3.1. cglib 的实现原理](#1131-cglib-的实现原理)
- [12. 集合容器](#12-集合容器)
  - [12.1. HashMap1.7 的实现](#121-hashmap17-的实现)
  - [12.2. HashMap 1.8 的实现](#122-hashmap-18-的实现)
  - [12.3. HashMap 的 hash 方法](#123-hashmap-的-hash-方法)
  - [12.4. jdk1.7 的 HashMap 的死循环](#124-jdk17-的-hashmap-的死循环)
  - [12.5. 有没有有序的 Map？](#125-有没有有序的-map)
- [13. JAVA 中容器的数据结构实现](#13-java-中容器的数据结构实现)
- [14. Jdk IO](#14-jdk-io)
- [15. Java 网络 IO](#15-java-网络-io)
  - [15.1. BIO（一个连接一个线程）](#151-bio一个连接一个线程)
  - [15.2. BIO 线程池](#152-bio-线程池)
  - [15.3. NIO（一个请求一个线程）， Reactor](#153-nio一个请求一个线程-reactor)
    - [15.3.1. Channel](#1531-channel)
    - [15.3.2. Buffer](#1532-buffer)
    - [15.3.3. Selector（Reactor）](#1533-selectorreactor)
  - [15.4. AIO（一个有效请求一个线程），Proactor](#154-aio一个有效请求一个线程proactor)
...
## 8. ClassNotFoundException 和 NoClassDefFoundException 的区别？
...
## 10. Thread.sleep、Thread.yield、obj.wait、t.join 的区别？
...
#### 15.3.3. Selector（Reactor）

### 15.4. AIO（一个有效请求一个线程），Proactor
